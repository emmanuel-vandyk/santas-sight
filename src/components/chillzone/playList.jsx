...
export const Playlist = ({ songs, onSongSelect, currentSongIndex }) => {
  return (
    <Card className="bg-gradient-to-b from-red-200 to-green-200 backdrop-blur-lg h-full">
      <CardHeader>
        <CardTitle className="text-green-700 text-center font-bold">Christmas playlist 2024</CardTitle>
      </CardHeader>
      <CardContent>
        <ScrollArea className="h-[300px] md:h-[400px] w-full rounded-lg shadow-zinc-500 p-4 shadow-md">
